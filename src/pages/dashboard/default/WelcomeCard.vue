                ...
                <div class="media">
                    <div class="media-body">
                        <div class="greeting-user">
                            <h4 class="f-w-600 mb-0">Herakles Termal Otel </h4>
                            <p>Soru görüş ve önerileriniz için lütfen bizimle iletişime geçiniz.!</p>
                            <div class="whatsnew-btn">
                                <a href="https://wa.me/+905343358496" target="blank" class="btn btn-outline-white">İletişime Geç</a>
                            </div>
                        </div>
                    </div>
                    <div>
