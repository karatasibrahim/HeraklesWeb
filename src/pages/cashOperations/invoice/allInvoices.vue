<template>
  <Breadcrumbs title="Fatura Listesi " main="Kasa İşlemleri" />
  <div>
    <!-- ADD MODAL   -->
    <!--  <div class="col-12">
      ...
      <div class="row">
        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-md-3">
                            <div class="mb-3 row">
                                <label class="col-sm-6 col-form-label">Başlangıç Tarihi:</label>
                                <div class="col-sm-6"> <input class="form-control digits" type="date" name="date"> </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3 row">
                                <label class="col-sm-6 col-form-label">Bitiş Tarihi:</label>
                                <div class="col-sm-6"> <input class="form-control digits" type="date" name="date"> </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-select form-control-inverse" name="select">
                                        ...
                                        <option value="opt1">Fatura Kesildi</option>
                                        <option value="opt2">Hepsi</option>
                                        <option value="opt3">Fatura Kesilmedi</option>
                                        <option value="opt4">İptal</option>
            ...
            <div class="  col-md-2">
              <a class="btn btn-primary btn-md" type="button" href="/cash-operations/invoice/addInvoice"
                style="float: right;">
                Yeni Ekle
              </a>
            ...
            <th scope="col">Güncelleyen Kullanıcı</th> -->
              ...
              <tbody>
                <tr v-for="(item, index) in GetRoomInfo" :key="item.id" class="border-bottom-primary">
                  ...
                  <td style="width:250px"> 0124696565</td>
                  <td style="width:150px">Mustafa KIRÇALI</td>
                  <td style="width:200px">15.06.2023 00:00</td>
                  <td style="width:200px">Taslak/Fatura kesilmedi</td>
