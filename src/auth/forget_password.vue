                            ...
                            <div class="login-main">
                                <form class="theme-form" @submit.prevent="">
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">E-postanızı giriniz</label>
                                        <div class="row">
                              ...
                              <input class="form-control" type="text" placeholder="E-posta adresiniz">
                                            ...
                                            <div class="col-12">
                                                <div class="text-end">
                                                    <button class="btn btn-primary btn-block m-t-10">Gönder</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <p class="mt-4 mb-0 text-center">Hesabınız var mı? <router-link class="ms-2"   to="/auth/login">
                                            Giriş Yap
                                        </router-link>
                                    </p>
                                </form>
