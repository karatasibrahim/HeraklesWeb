...
import Rooms from "../pages/roomOperations/rooms.vue";
import Blokaj from "../pages/roomOperations/blokaj.vue";
import Housekeeping from "../pages/roomOperations/housekeeping.vue";

// Reservation
import addBooking from "../pages/reservation/addBooking.vue";
import bookingList from "../pages/reservation/bookingList.vue";

import customer from "../pages/office/customer.vue";
import FileManager from "../pages/office/filemanager.vue";
import addExpense from "../pages/cashOperations/expenses/addExpense.vue";
//import allExpenses from '../pages/cashOperations/expenses/allExpenses.vue'
import addInvoice from "../pages/cashOperations/invoice/addInvoice.vue";
import allInvoices from "../pages/cashOperations/invoice/allInvoices.vue";
import dailyCash from "../pages/cashOperations/dailyCash.vue";
import monthlyCash from "../pages/cashOperations/monthlyCash.vue";
import financialState from "../pages/cashOperations/financialState.vue";
import kitchenReport from "../pages/reports/kitchenReport.vue";
import housekeepingReport from "../pages/reports/housekeepingReport.vue";
import forecastReport from "../pages/reports/forecastReport.vue";
import logReport from "../pages/reports/logReport.vue";
import ReportNewCustomer from "../pages/reports/ReportNewCustomer.vue";
import ReportCustomer from "../pages/reports/ReportCustomer.vue";

// Company Settings

import currencyUnit from "../pages/companySettings/information/currencyUnit.vue";
import department from "../pages/companySettings/information/department.vue";
import agents from "../pages/companySettings/information/agents.vue";
import employee from "../pages/companySettings/information/employee.vue";
import laundry from "../pages/companySettings/information/laundry.vue";
import paymentType from "../pages/companySettings/information/paymentType.vue";
import roomInfo from "../pages/companySettings/information/roomInfo.vue";
import roomGroup from "../pages/companySettings/information/roomGroup.vue";
import roomCheck from "../pages/companySettings/information/roomCheck.vue";
import roomPricing from "../pages/companySettings/information/roomPricing.vue";
import roomType from "../pages/companySettings/information/roomType.vue";
import stock from "../pages/companySettings/information/stock.vue";
import branch from "../pages/companySettings/information/branch.vue";
import cashSettings from "../pages/companySettings/settings/cashSettings.vue";

import generalSettings from "../pages/companySettings/settings/generalSettings.vue";
import invoiceSettings from "../pages/companySettings/settings/invoiceSettings.vue";
import reservationSettings from "../pages/companySettings/settings/reservationSettings.vue";
import roomFeatures from "../pages/companySettings/information/roomFeatures.vue";
/* Auth */
...
const routes = [
  { path: "/", redirect: { name: "defaultRoot" } },
  { path: "/", redirect: { name: "auth/login" } },
  { path: "/", redirect: { name: "auth/register" } },
  { path: "/", redirect: { name: "auth/forget_password" } },

  { path: "/", redirect: { name: "reservation" } },
  { path: "/", redirect: { name: "reservation/addBooking" } },
  { path: "/", redirect: { name: "reservation/bookingList" } },
  { path: "/", redirect: { name: "office" } },
  { path: "/", redirect: { name: "office/customer" } },
  { path: "/", redirect: { name: "office/filemanager" } },
  { path: "/", redirect: { name: "cash-operations" } },
  {
    path: "/",
    redirect: { name: "company-settings/settings/generalsettings" },
  },
  { path: "/", redirect: { name: "cash-operations/expenses/addExpense" } },
  { path: "/", redirect: { name: "reports" } },
  { path: "/", redirect: { name: "reports/kitchenReport" } },
  { path: "/", redirect: { name: "reports/forecastReport" } },
  { path: "/", redirect: { name: "reports/housekeepingReport" } },
  { path: "/", redirect: { name: "reports/logReport" } },
  { path: "/", redirect: { name: "company-settings" } },
  { path: "/", redirect: { name: "company-settings/information/branch" } },
  { path: "/", redirect: { name: "company-settings/information/agents" } },
  { path: "/", redirect: { name: "company-settings/information/laundry" } },
  { path: "/", redirect: { name: "company-settings/information/roomType" } },
  { path: "/", redirect: { name: "company-settings/information/roomGroup" } },
  { path: "/", redirect: { name: "company-settings/information/roomInfo" } },
  { path: "/", redirect: { name: "company-settings/information/roomCheck" } },
  {
    path: "/",
    redirect: { name: "company-settings/information/roomFeatures" },
  },
  { path: "/", redirect: { name: "company-settings/information/roomPricing" } },
  {
    path: "/",
    redirect: { name: "company-settings/information/currencyUnit" },
  },
  { path: "/", redirect: { name: "company-settings/information/paymentType" } },
  { path: "/", redirect: { name: "company-settings/information/employee" } },
  { path: "/", redirect: { name: "company-settings/information/department" } },
  { path: "/", redirect: { name: "company-settings/information/stock" } },
  { path: "/", redirect: { name: "company-settings/settings/cashsettings" } },
  {
    path: "/",
    redirect: { name: "company-settings/settings/invoicesettings" },
  },
  {
    path: "/",
    redirect: { name: "company-settings/settings/reservationsettings" },
  },
...

  {
    ...
    children: [
      ...
      {
        path: "ReportNewCustomer",
        name: "ReportNewCustomer",
        component: ReportNewCustomer,
        meta: {
          title: "Herakles Termal Otel",
        },
      },
...
function isAuth() {
  return localStorage.hasOwnProperty("storedData");
}
router.beforeEach((to, from, next) => {
  if (to.meta.title) document.title = to.meta.title;
  const auth = isAuth();
  const path = ["/auth/login", "/auth/register", "/auth/forget_password"];
  const uid =
    auth == true ? JSON.parse(localStorage.getItem("storedData")).userUid : "";
  if (path.includes(to.path) || localStorage.getItem("storedData")) {
    return next();
  }
  next("/auth/login");
});
